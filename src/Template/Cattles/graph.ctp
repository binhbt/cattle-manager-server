...
$(document).ready(function(){
    ...
    <div id="chart1" style="margin-top:20px; margin-left:20px; width:300%;margin-right:auto;margin-left:auto; height:600px;"></div>
     </div>
    ...
    <div id="chart2" style="margin-top:20px; margin-left:20px; width:300%;margin-right:auto;margin-left:auto; height:300px;"></div>
     </div>
        </body>
</html>